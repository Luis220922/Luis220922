...
### Hola! Soy un desarrollador Full Stack apasionado por crear aplicaciones web desde el frontend hasta el backend.

---

### 🚀 Sobre mí
- 💻 Desarrollador Full Stack (Frontend + Backend)
- ⚛️ Frontend: React, TypeScript, Bootstrap, Vite
- ☕ Backend: Java, Spring Boot, Servlets
- 🗄️ Bases de datos: MySQL
- 🌱 Siempre aprendiendo nuevas tecnologías
- 🎯 Enfocado en mejorar como ingeniero de software y conseguir mi primer empleo en el área
...
### 📌 Enfoque
Construcción de proyectos reales, mejora de arquitectura backend y crecimiento como desarrollador Full Stack.
